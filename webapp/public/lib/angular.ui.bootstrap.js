...
.directive('progressbar', function() {
    return {
        ...
        templateUrl: '../../../webapp/angular/app/lib/angular/template/progressbar/progressbar.html',
        link: function(scope, element, attrs, progressCtrl) {
...
angular.module("template/rating/rating.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("template/rating/rating.html",
    ...
    "    <i ng-repeat=\"r in range track by $index\" ng-mouseenter=\"enter($index + 1)\" ng-click=\"rate($index + 1)\" ng-class=\"$index < value && (r.stateOn || 'icon-star') || (r.stateOff || 'icon-star-empty')\">\n" +

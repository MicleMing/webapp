            ...
            function ($http, $document, $compile, $rootScope, $controller, $templateCache, $q, $injector, $position, $timeout) {
                ...
                return g.prototype.isOpen = function () {
                    ...
                    if (m.hasClass("popbox-open") && $("." + c).length > 0) {
                        if (this._target[0] === $("." + c).scope().popbox._target[0]) return $("." + c).scope().popbox.close(), void 0;
                    ...
                    return this._loadResolves().then(function (e) {
                        ...
                        var c = kzi.util.docWidth(),
                            u = kzi.util.docHeight(),
                            d = kzi.util.docOuterWidth();
                    ...
                    var i = this;
                    this._getFadingElements(), _.isFunction(i.$watcher) && i.$watcher(), m.removeClass(i.options.popboxOpenClass), this._onCloseComplete(e, t)
